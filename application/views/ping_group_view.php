...
<div data-role="page" id="pagetwo" data-theme="b">
  ...
  <div data-role="content">
    <form method="post" action="ping_group" onchange="javascript: submit();">
      <fieldset data-role="fieldcontain">
        <label for="ui">请选择组</label>
        <select name="gg_now" id="gg_now">
<?php foreach($ggroupid->result() as $row)
{
   ...
   if ($gid_now == $groupid){
   echo "<option "." value=".$groupid." selected>".$name."</option>" ;
   }
   if ($gid_now !== $groupid){
...
?>
  ...
  <div data-role="content">
    <form method="post" action="ping_run" >
   ...
   <?php $group = $row->groupid; ?>
    ...
    <input type="radio" name="ip" id=<?php echo $ip ;?> value=<?php echo $ip."::".$name ;?> >	
	<?php endforeach;?>
      </fieldset>
